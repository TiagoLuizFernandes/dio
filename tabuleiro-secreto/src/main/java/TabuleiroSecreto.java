...
public class TabuleiroSecreto {
    ...
    public static void main(String[] args) {
        ...
        int tamTab = Integer.parseInt(linha.split(" ")[0]);
        ...
        for(Map<String, Integer> operacao : operacoes) {
            ...
            if(operacao.get("tipoOp") == 1) {
                ...
                realizarOperacao1(operacao, tabuleiro, tamTab);

            } else if(operacao.get("tipoOp") == 2) {

                realizarOperacao2(operacao, tabuleiro, tamTab);
    ...
    private static List<Map<String, Integer>> lerOperacoes(Integer qtOp, Iterator<String> it) {
        ...
        List<Map<String, Integer>> operacoes = new ArrayList<>();

        for(int i = 0; i < qtOp; i++) {

            String strOperacao = it.next();
            int tipoOp = Integer.parseInt(strOperacao.split(" ")[0]);
            ...
            if(tipoOp == 1 || tipoOp == 2) {
                ...
                Map<String, Integer> operacao = new HashMap<>();
    ...
    private static void realizarOperacao1(Map<String, Integer> operacao,
                                          Integer[][] tabuleiro,
                                          int tamTab) {
    ...
    private static void realizarOperacao2(Map<String, Integer> operacao,
                                          Integer[][] tabuleiro,
                                          int tamTab) {
        for(int i = 0; i < tamTab; i++) {
    ...
    private static Map<Integer, Integer> lerRepeticoesLinhaX(Map<String, Integer> operacao,
        ...
        Map<Integer, Integer> repeticoesNumero = new HashMap<>();
    ...
    public static Integer avaliaMaiorNumeroComMaiorRepeticao(Map<Integer, Integer> repeticoesNumero) {
        ...
        List<Integer> maioresRepeticoes = new ArrayList<>();
        Integer maiorRepeticao = Collections.max (repeticoesNumero.values());

        List<Integer> chaves = new ArrayList<>(repeticoesNumero.keySet());
        ...
        return Collections.max(maioresRepeticoes);
